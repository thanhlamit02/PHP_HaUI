...
<body>
    ...
    <section class="add-products">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <input type="text" name="name" class="box-add" placeholder="Thể loại" required>
            <input type="text" name="describes" class="box-add" placeholder="Mô tả" required>
            <input type="submit" value="Thêm sách" name="add_category" class="option-btn">
        </form>
            ...
            ?>
                    <div class="box">
                        ...
                        <div class="btn-show">
                            ...
                            <a href="./ad_category.php?update=<?php echo $fetch_categorys['id']; ?>" class="option-btn">Cập nhật</a>
                            <a href="./ad_category.php?delete=<?php echo $fetch_categorys['id']; ?>" class="delete-btn" onclick="return confirm('Xóa thể loại sách này?');">Xóa</a>
                        </div>
                    </div>
            <?php
                }
        ...
        ?>
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="btn-show">
                            ...
                            <input type="submit" value="Cập nhật" name="update_category" class="option-btn"> <!-- submit form cập nhật -->
                            <input type="reset" value="Hủy" onclick="window.location.href = './ad_category.php'" class="delete-btn">
                        </div>
                    </form>
        <?php
                }
