...
<head>
    ...
    <link rel="stylesheet" href="./admin_css/admin_contact.css">
        ...
        <div class="box-container">
            ...
            ?>
                    <div class="box">
                        ...
                        <a  class="btn-delete" href="ad_contact.php?delete=<?php echo $fetch_message['id']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa tin nhắn này?');" class="delete-btn">Xóa tin nhắn</a>
                    </div>
            <?php
                };
            } else {
